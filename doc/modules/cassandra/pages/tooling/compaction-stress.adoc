...
The `compaction-stress` tool is used to benchmark and test Cassandra compaction throughput and performance with a generated sstables.

The `compaction-stress` tool like `cassandra-stress` that works with stress yaml(e.g. `cqlstress-example.yaml`) but:
...
This tool was implemented in https://issues.apache.org/jira/browse/CASSANDRA-11844[CASSANDRA-11844]

This documentation focuses on user mode to test compaction throughput and performance.

➜  bin git:(CASSANDRA-14288) ✗ history|grep compaction-stress
8587  ./tools/bin/compaction-stress write -d /tmp/compaction -g 5 -p https://gist.githubusercontent.com/tjake/8995058fed11d9921e31/raw/a9334d1090017bf546d003e271747351a40692ea/blogpost.yaml -t 4
8588  ../compaction-stress write -d /tmp/compaction -g 5 -p https://gist.githubusercontent.com/tjake/8995058fed11d9921e31/raw/a9334d1090017bf546d003e271747351a40692ea/blogpost.yaml -t 4
8590  ./compaction-stress write -d /tmp/compaction -g 5 -p https://gist.githubusercontent.com/tjake/8995058fed11d9921e31/raw/a9334d1090017bf546d003e271747351a40692ea/blogpost.yaml -t 4
8593  ./compaction-stress write -d /tmp/compaction -g 5 -p https://gist.githubusercontent.com/tjake/8995058fed11d9921e31/raw/a9334d1090017bf546d003e271747351a40692ea/blogpost.yaml -t 4
8597  ./compaction-stress write -d /tmp/compaction -g 5 -p /tmp/blogpost.yaml -t 4
8599  ./compaction-stress write -d /tmp/compaction -g 5 -p /tmp/blogpost.yaml -t 4
8600  ./compaction-stress compact -d /tmp/compaction -g 5 -p /tmp/blogpost.yaml -t 4
8601  ./compaction-stress compact -d /tmp/compaction -p /tmp/blogpost.yaml -t 4
8756  ./compaction-stress compact -d /tmp/compaction -p /tmp/blogpost.yaml -t 4
8761  ./compaction-stress compact -d /tmp/compaction -p /tmp/blogpost.yaml -t 4
